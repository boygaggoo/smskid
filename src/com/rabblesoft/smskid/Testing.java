...
//        enableSMSButton.getBackground().setColorFilter(0xFF00CC00, PorterDuff.Mode.MULTIPLY);
        ...
        Button start_button = (Button) findViewById(R.id.start_test);    
        Button cancel_button = (Button) findViewById(R.id.cancel_test);   
        
        start_button.getBackground().setColorFilter(0xFF00CC00, PorterDuff.Mode.MULTIPLY);
        cancel_button.getBackground().setColorFilter(0xFFFF0000, PorterDuff.Mode.MULTIPLY);
